...
def enumerate_rpc_executions(rpc: ModelRPC, device_mesh: DeviceMesh, seq_len: int, num_gen_tokens: int,
    ...
    for sub_device_mesh in sub_device_meshes:
        ...
        for parallel in ps:
            ...
            bs = rpc.min_n_seqs
            # seq_len = seq_len
            min_bs = 2 * num_dp * num_pp * n_ppo_minibatches\
            ...
            time_cost = estimate_rpc_time_cost(rpc,
                                               parallel,
                                               bs=bs,
                                               seq_len=seq_len,
                                               num_gen_tokens=num_gen_tokens,

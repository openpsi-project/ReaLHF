...
from realrlhf.base.namedarray import from_dict, NamedArray, recursive_apply
...
from realrlhf.impl.model.utils.functional import (
    apply_logits_mask,
    gather_packed_shifted_log_probs,
    masked_normalization,
)
from realrlhf.impl.model.utils.padding import unpad_input
...
import realrlhf.impl.model.utils.ppo_functional as ppo_functional
...
class PPOActorInterface(model_api.ModelInterface):
    ...
    def __post_init__(self):
        ...
        if self.value_norm:
            from realrlhf.impl.model.modules import (

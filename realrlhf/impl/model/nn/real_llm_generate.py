...
# import realrlhf.impl.model.parallelism.model_parallel.custom_all_reduce as custom_all_reduce
...
from realrlhf.impl.model.utils.functional import mask_eos_token
from realrlhf.impl.model.utils.logits_warper import top_k_top_p_logits
from realrlhf.impl.model.utils.padding import index_first_axis, unpad_input
...
def genstep(
    ...
    if constants.model_parallel_world_size() > 1:
        from realrlhf.impl.model.parallelism.model_parallel.mappings import (

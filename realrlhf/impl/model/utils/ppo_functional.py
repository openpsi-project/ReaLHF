...
from realrlhf.impl.model.parallelism.model_parallel.utils import VocabUtility
from realrlhf.impl.model.utils.functional import build_leave_one_indices
...
def cugae1d_nolp_misalign_func(
    ...
    """
    import realrlhf._C.cugae as gae_cuda

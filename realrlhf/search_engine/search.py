...
try:
    import realrlhf._C.mdm_search as mdm_search
...
def search_rpc_allocations(
    ...
    from realrlhf.search_engine.enumerate import build_graph
    from realrlhf.search_engine.estimate import get_param_realloc_stats
...
def make_rpc_exe_list(
    ...
    from realrlhf.search_engine.enumerate import enumerate_rpc_executions

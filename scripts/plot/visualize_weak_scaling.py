...
from reallm.base.monitor import caculuate_llama_forward_flops, calculate_llama_gen_flops, calculate_llama_train_flops
...
def main():
    ...
    plt.savefig("assets/figures/vws.pdf", bbox_inches="tight")

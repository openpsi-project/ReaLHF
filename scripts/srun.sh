...
srun --nodes=1 --cpus-per-task=10 --mem=100G --container-image=llm/llm-cpu:reallm-20240527 --nodelist=QH-com$1 \
     --container-mounts=/lustre:/lustre --container-mount-home --export=PYTHONUSERBASE=/nonsense \
     --pty bash
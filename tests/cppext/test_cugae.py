...
from impl.model.utils.ppo_functional import (cugae1d_nolp_misalign_func, cugae2d_nolp_func, cugae2d_olp_func,
...
def test_gae1d_nolp_misalign(max_seqlen: int, bs: int, gamma: float, lam: float):
    ...
    adv, ret = cugae1d_nolp_misalign_func(rewards, values, cu_seqlens, bootstrap, gamma, lam)

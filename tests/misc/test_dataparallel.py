...
class PackedTest(unittest.TestCase):
    ...
    def test_scatter_to(self):
        ...
        src = [get_packed_namedarray(i) for i in nseqs_batch]
        res = dp.ParallelDataBroker.gather_from(src)
        splitted = dp.ParallelDataBroker.scatter_to(res, n_dp=int(torch.randint(2, 5, (1,))))
        res2 = dp.ParallelDataBroker.gather_from(splitted)
        ...
        splitted1 = dp.ParallelDataBroker.scatter_to(res, n_dp=n_dp)
        splitted2 = dp.ParallelDataBroker.scatter_to(res, n_dp=n_dp)
